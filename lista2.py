...
#   a adição, caso o resultado seja maior que 10, apresentá-lo.# ler dois valores inteiros
def q1():
...
def q5():
    ...
    if num % 3 == 0 and num % 7== 0: #se o resto da divisao e zero
        print (f'{num}é divisivel por 3 e 7')
    else:
        print (f'{num} nao édivisivel por 3 e 7')
